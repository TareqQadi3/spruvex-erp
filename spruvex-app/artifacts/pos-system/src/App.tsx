...
const ProductImportPage = lazy(() => import("@/pages/inventory/import"));
  ...
  return (
    <AppLayout>
      ...
      <Switch>
        ...
        <Route path="/inventory/import"><GuardedPage component={ProductImportPage} basePath="/inventory" /></Route>
