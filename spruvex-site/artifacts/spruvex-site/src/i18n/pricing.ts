export const pricing = {
  ar: {
    ...
    price_sub: "أسعار شفافة وواضحة، بدون رسوم مخفية. اختر الباقة المناسبة لنشاطك وابدأ فوراً.",
    price_per_month: "ريال / شهرياً", price_contact_us: "تواصل معنا",
    price_loading: "جاري تحميل الباقات...", price_error: "تعذّر تحميل الباقات حالياً، حاول مرة أخرى.", price_retry: "إعادة المحاولة",
    plan_cta: "ابدأ الآن",
    price_limit_users: "حتى {n} مستخدمين", price_limit_branches: "حتى {n} فرع", price_limit_products: "حتى {n} منتج",
    price_limit_customers: "حتى {n} عميل", price_limit_invoices: "حتى {n} فاتورة شهرياً", price_limit_storage: "{n} ميجابايت مساحة تخزين",
  ...
  en: {
    ...
    price_sub: "Transparent, clear pricing with no hidden fees. Pick the plan that fits your business and get started right away.",
    price_per_month: "SAR / month", price_contact_us: "Contact us",
    price_loading: "Loading plans...", price_error: "Couldn't load plans right now, please try again.", price_retry: "Retry",
    plan_cta: "Get started",
    price_limit_users: "Up to {n} users", price_limit_branches: "Up to {n} branches", price_limit_products: "Up to {n} products",
    price_limit_customers: "Up to {n} customers", price_limit_invoices: "Up to {n} invoices/month", price_limit_storage: "{n} MB storage",
